...
/* eslint-disable */
// eslint is for node.js not for javascript
// console.log(locations);
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXBwbGVzbGVlcCIsImEiOiJja3R0enJwNDgxdm96Mm5udXl2d2Vld3RsIn0.ez9HULscXPsO2c3aec-EqQ';
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51JcqjrCx7vD8gifp17uCUk5pZZ3WrThkdSULgcOhFbEndF4aZzBgs0HoYj5pVRph9BqpQCUhV0N4zhaBcuvVEJYw00XJnZrzhQ');
            _context.prev = 1;
            _context.next = 4;
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    // this prevent the form from loading other pages?
    e.preventDefault();
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  e.target.textContent = 'Processing...'; // const { tourId } = e.target.dataset; is the same as
